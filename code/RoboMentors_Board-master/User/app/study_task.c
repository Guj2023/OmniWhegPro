...
//	while(1){
//		
//		write_uart(USER_UART5,(uint8_t *)"hello world!\n",13);
//		osDelay(500);
//	}
//}
...
////实验：串口通讯 CAN数据发送与接收 NEED Battry
//#include "rm_hal_lib.h"
//#include "cmsis_os.h"
...
//	can1_send[1] = 1;
//	
//	write_can(USER_CAN1,0x202,can1_send);
//	
//	while(1){
...
//	
//	//第1个电机
//	can1_send_data[0]=100>>8;//实验只用1电机，像电调发送电流数据，空转时给小值1000（二进制，相比65535是一个比较小的值）
//	can1_send_data[1]=0;
//	
//	//第2个电机
